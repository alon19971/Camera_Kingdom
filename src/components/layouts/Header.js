...
const Header = () => {
  ...
  const handleLogout = async () => {
    try {
      ...
      alert("An error occurred while attempting to log out. Please contact support");
            ...
            <Dropdown align="end">
              <Dropdown.Toggle variant="light" id="dropdown-basic">
                ...
                {currentUser.photoURL ? (
                  <Image src={currentUser.photoURL} roundedCircle width={30} height={30} />
                ) : (
                  <Image src={userImage} roundedCircle width={35} height={35} />
                )}
              </Dropdown.Toggle>
              ...
              <Dropdown.Menu>
                ...
                {userData?.isAdmin && (
                  <LinkContainer to="/manager">
                    <Dropdown.Item className="admin-dashboard-text">Admin Dashboard</Dropdown.Item>
                  </LinkContainer>
                )}
                <Dropdown.Divider />
